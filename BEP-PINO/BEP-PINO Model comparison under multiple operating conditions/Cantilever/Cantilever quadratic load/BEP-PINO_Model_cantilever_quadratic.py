...
class FNO_Combined(nn.Module):
    ...
    def predict_with_ansatz(self, branch_input, x_batch, L, bc_type=BC_TYPE):
        ...
        u_pred = (x_batch**2) * u_scaled
        phi_pred = x_batch * phi_scaled
        M_pred = (L - x_batch) * M_scaled
        Q_pred = (L - x_batch) * Q_scaled
...
if __name__ == "__main__":
    ...
    print("================ Adam Training: Symmetric Quadratic Load / Cantilever ================")

...
TARGET_RELATIVE_DIR = Path("BEP-PINO Model comparison under multiple operating conditions/Fixed-fixed/Fixed-fixed linear load")
MODEL_SAVE_PATH = "BEP-PINO_Model_Linear_fixed-fixed.pth"
LOGS_SAVE_PATH = "BEP-PINO_Logs_Linear_fixed-fixed.pth"
BC_TYPE = "fixed-fixed"
LOAD_KIND = "linear"
...
if __name__ == "__main__":
    ...
    print("================ Adam Training: Linear Distributed Load / Fixed-Fixed ================")

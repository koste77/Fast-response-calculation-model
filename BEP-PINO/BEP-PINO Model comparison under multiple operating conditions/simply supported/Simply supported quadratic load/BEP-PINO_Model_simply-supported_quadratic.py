...
TRAINING_SCRIPT = "BP-PFNO_Model_simply-supported_quadratic.py"
TARGET_RELATIVE_DIR = Path("BP-PFNO/简支加荷载/二次荷载")
MODEL_SAVE_PATH = "BP-PFNO_Model_Quadratic_2Param_simply-supported.pth"
LOGS_SAVE_PATH = "BP-PFNO_Logs_Quadratic_2Param_simply-supported.pth"
...
if __name__ == "__main__":
    ...
    print("================ Adam Training: Symmetric Quadratic Load / Simply-Supported ================")

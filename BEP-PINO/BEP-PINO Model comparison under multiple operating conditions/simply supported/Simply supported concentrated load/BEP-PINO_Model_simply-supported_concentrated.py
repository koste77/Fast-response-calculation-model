...
TARGET_RELATIVE_DIR = Path("BEP-PINO Model comparison under multiple operating conditions/simply supported/Simply supported concentrated load")
MODEL_SAVE_PATH = "BEP-PINO_Model_Concentrated_simply-supported.pth"
LOGS_SAVE_PATH = "BEP-PINO_Logs_Concentrated_simply-supported.pth"
...
if __name__ == "__main__":
    ...
    print("================ Adam Training: Gaussian Localized Load / Simply-Supported ================")

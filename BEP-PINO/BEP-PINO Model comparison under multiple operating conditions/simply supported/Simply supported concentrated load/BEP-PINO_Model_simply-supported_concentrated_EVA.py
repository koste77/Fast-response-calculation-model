...
TRAINING_SCRIPT = "BP-PFNO_Model_simply-supported_concentrated.py"
TARGET_RELATIVE_DIR = Path("BP-PFNO/简支加荷载/集中荷载")
MODEL_SAVE_PATH = "BP-PFNO_Model_Concentrated_simply-supported.pth"
LOGS_SAVE_PATH = "BP-PFNO_Logs_Concentrated_simply-supported.pth"
LOAD_KIND = "concentrated"
BC_TYPE = "simply-supported"
BOUNDARY_TITLE = "Simply-Supported"
LOAD_TITLE = "Gaussian Localized Load"
...
def test_cases():
    ...
    if LOAD_KIND == "linear":
        return [(-0.25, -0.05), (-0.05, -0.20), (-0.15, -0.15)]
    if LOAD_KIND == "quadratic":
        return [(-0.20, 0.05), (-0.05, 0.10), (-0.15, 0.08)]

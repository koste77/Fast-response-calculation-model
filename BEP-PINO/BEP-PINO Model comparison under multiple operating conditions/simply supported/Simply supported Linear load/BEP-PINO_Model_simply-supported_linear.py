...
TRAINING_SCRIPT = "BP-PFNO_Model_simply-supported_linear.py"
TARGET_RELATIVE_DIR = Path("BP-PFNO/简支加荷载/一次荷载")
MODEL_SAVE_PATH = "BP-PFNO_Model_Linear_simply-supported.pth"
LOGS_SAVE_PATH = "BP-PFNO_Logs_Linear_simply-supported.pth"
...
if __name__ == "__main__":
    ...
    print("================ Adam Training: Linear Distributed Load / Simply-Supported ================")

...
model_path = "BEP-PFNO_Model_fixed-fixed concentrated.pth"
logs_path = "BEP-PFNO_Logs_fixed-fixed concentrated"
...
print("\n" + "="*85)
print(" BEP-PINO vs high precision Hermite FEM Quantitative evaluation report on structural response depth")
print("="*85)

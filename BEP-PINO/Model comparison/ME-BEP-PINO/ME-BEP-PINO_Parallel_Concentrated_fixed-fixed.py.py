...
if __name__ == '__main__':
    ...
    model = ME_BEP_PINO_Parallel(m_sensors=m_sensors, modes=16, width=64)
    ...
    print("================  Adam  (ME_BEP_PINO_Parallel  - concentrated) ================")
    ...
    for epoch in range(epochs):
        ...
        if epoch % 100 == 0 or epoch == epochs - 1:
            ...
            print(f"Epoch {epoch:4d} | Total Loss: {loss.item():.4e} | Raw Loss: {raw_total_loss:.4e} | Times: {elapsed_time:.2f}s")  

    print("Adam Finish, start L-BFGS...")
...
model_save_path = "ME-BP-PFNO_Parallel_Model_fixed-fixed_Concentrated.pth"
...
logs_save_path = "ME-BP-PFNO_Parallel_Logs_fixed-fixed_Concentrated.pth"
